...
/**
* Check if user is in local development environment
**/
...
{
	echo ( '<a class = "'.$class.'" href="' ._ROOT. '">
			<img src="' . getOption( 'homelogo' ) . '" width="' . $width . '">
		</a>' );
}
...
{	
	echo ( '<a class = "'.$class.'" href="' ._ROOT. '">
			<img src="' . getOption( 'headerlogo' ) . '" width="' . $width . '">
		</a>' );
}
...
function showOption( $code )
{
    ...
    //echo ( $GLOBALS['OPTIONS'] -> getOption( $code ) );
}
...
{ ?>
	...
	<?php foreach ($fields as $field ) { ?>
		...
		<i class="<?php echo( $field['icon-class'] ); ?>"><?php echo( $field['icon'] ); ?></i>
			<<?php echo( $field['genre'] ); ?> class="<?php echo( $field['class'] ); ?>" type="<?php echo( $field['type'] ); ?>" name="<?php echo( $field['name'] ); ?>" placeholder="<?php echo( $field['placeholder'] ); ?>" value=""><?php echo( $field['value'] ); ?>
			</<?php echo( $field['genre'] ); ?>>
		</div>
	<?php } ?>
	</form><?php
}
