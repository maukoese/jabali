...
<div class="mdl-layout mdl-layout-transparent mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
  ...
  <header class="mdl-layout__header mdl-layout__header--waterfall mdl-color-text--grey-600 mdl-color--<?php if ( isset( $_SESSION[JBLSALT.'Code'] ) ) { primaryColor(); } else { echo "madge"; } ?>">
    <div class="mdl-layout__header-row">
      ...
      <a href="<?php echo _ROOT.'/about'; ?>" class="mdi mdi-email mdl-badge mdl-badge--overlap mdl-button--icon notification" id="h_contact"></a>
      <div class="mdl-tooltip" for="h_contact">Contact</div>

      <a href="<?php echo _ROOT.'/signup/user'; ?>" class="mdi mdi-account-plus mdl-badge mdl-badge--overlap mdl-button--icon notification" id="h_submit"></a>
    ...
    <div class="mdl-layout__header-row" style="overflow-x: auto;">
      <div class="mdl-layout-spacer"></div>
        <?php $header = new Jabali\Classes\Menus();
        $header -> header(); ?>
    </div>
  </header>
