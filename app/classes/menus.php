...
class Menus {
	...
	* Create menu
	**/
	function create( $name, $author, $avatar, $code, $for, $link, $location, $state, $ilk ){
		if( $GLOBALS['JBLDB'] -> query( "INSERT INTO ". _DBPREFIX ."menus ( name, author, avatar, code, parent, link, location, state, ilk ) VALUES ( '".$name."', '".$author."', '".$avatar."', '".$code."', '".$for."', '".$link."', '".$location."', '".$state."', '".$ilk."')" ) ) {
               printf("<div id=\"success\" class=\"alert mdl-color--green\"><span>%s</span></div>", "");
     ...
     * Create menu
     **/
     function install( $name, $author, $avatar, $code, $for, $link, $location, $state, $ilk ){
          if( !$GLOBALS['JBLDB'] -> query( "INSERT INTO ". _DBPREFIX ."menus ( name, author, avatar, code, parent, link, location, state, ilk ) VALUES ( '".$name."', '".$author."', '".$avatar."', '".$code."', '".$for."', '".$link."', '".$location."', '".$state."', '".$ilk."')" ) ) {
               _shout_( "Error: ".$GLOBALS['JBLDB']->error()."!", "error" );
         }
     }

	function update( $name, $author, $avatar, $code, $for, $link, $location, $state, $ilk ){
		if( $GLOBALS['JBLDB'] -> query( "UPDATE ". _DBPREFIX ."menus SET name='".$name."', author='".$author."', avatar='".$avatar."', code='".$code."', parent='".$for."', link='".$link."', location='".$location."', state='".$state."', ilk='".$ilk."' WHERE code ='".$code."' " ) ) {
