...
class Comments {
    ...
    if ( $getCommentsBy -> num_rows > 0) { ?>
      ...
      while ( $commentsDetails = mysqli_fetch_assoc( $getComments)){ ?>
        ...
        <td class="mdl-data-table__cell--non-numeric" data-title="">
          <?php _show_( $commentsDetails['name'] ); ?>
        </td>
        <td class="mdl-data-table__cell--non-numeric" data-title="">
          <?php _show_( $commentsDetails['by'] ); ?>
        </td>
        <td class="mdl-data-table__cell--non-numeric" data-title="">
          <?php _show_( $commentsDetails['created'] ); ?>
        </td>
        <td class="mdl-data-table__cell--non-numeric" data-title="">
          <?php _show_( $commentsDetails['state'] ); ?>
        </td>
        <td class="mdl-data-table__cell--non-numeric" data-title="">
        <a href="./notification?create=<?php _show_( $commentsDetails['ilk'] ); ?>&code=<?php _show_( $commentsDetails['author'] ); ?>" ><i class="material-icons">reply</i></a> 
        <a href="./notification?view=<?php _show_( $commentsDetails['id'] ); ?>" ><i class="material-icons">open_in_new</i></a> 
        <a href="tel:<?php _show_( $commentsDetails['phone'] ); ?>" ><i class="material-icons">phone</i></a> 
        <!-- <a href="./notification?chat=<?php _show_( $commentsDetails['author'] ); ?>" ><i class="material-icons">question_answer</i></a>  -->
        <a href="./notification?delete=<?php _show_( $commentsDetails['id'] ); ?>" ><i class="material-icons">delete</i></a>
        </td>
        </tr>
        </tbody><?php 
      } ?>
  ...
  function getComment( $code) {
    ...
    if ( $getComment -> num_rows > 0) {
      ...
      <title><?php _show_( $commentDetails['name'] ); ?> [ <?php showOption( 'name' ); ?> ]</title>
        <div class="mdl-grid" >
              <div class="mdl-cell mdl-cell--8-col-desktop mdl-cell--8-col-tablet mdl-cell--12-col-phone">
                    <div class="mdl-card mdl-shadow--2dp mdl-color--<?php primaryColor(); ?>">
                        <div class="mdl-card__title">
                            <h2 class="mdl-card__title-text"><?php _show_( $commentDetails['name'] ); ?></h2>

                            <div class="mdl-layout-spacer"></div>
                            <div class="mdl-card__subtitle-text">
                                <a id="reply" href="./notification?create=<?php _show_( $commentDetails['ilk'] ); ?>&code=<?php _show_( $commentDetails['author'] ); ?>" ><i class="material-icons">reply</i></a>
                                <a id="chat" href="./notification?chat=<?php _show_( $commentDetails['author'] ); ?>" ><i class="material-icons">question_answer</i></a>
                        ...
                        <div class="mdl-card__supporting-text mdl-card--expand mdl-grid">
                          <div class="mdl-cell mdl-cell--8-col-desktop mdl-cell--8-col-tablet mdl-cell--12-col-phone">
                            <blockquote><?php _show_( $commentDetails['details'] ); ?></blockquote>
                          </div>
                          <div class="mdl-cell mdl-cell--4-col-desktop mdl-cell--4-col-tablet mdl-cell--2-col-phone">
                            <h5>From: <?php _show_( $commentDetails['email'] ); ?></h5>
                            <h5>Sent: <?php _show_( $commentDetails['created'] ); ?></h5>
                          </div>
                        </div>
                    </div>
                </div>
