...
class _hActions {
	...
	**/
			...
			exit();
		  	...
		  	<div style="padding-top:40px;" class="mdl-grid" >
			      ...
			      <div id="login_div" class="mdl-cell mdl-cell--8-col">
			          <center><?php echo '<a href="'.hROOT.'"><img src="'.hIMAGES.'logo-w.png" width="250px;"></a>'; 
			      if ( isset( $_GET['alert'] ) ) {
			          ...
			          <div class="input-field mdl-cell mdl-cell--2-col">
			          	<button class="mdl mdl-button mdl-button--fab mdl-js-button mdl-button--raised mdl-color--green alignright" type="submit" name="login"><i class="material-icons">send</i></button>
			          </div>
			          </form>
			      </div>
			  	<div class="mdl-cell mdl-cell--2-col"></div>
								...
								<div class="mdl-cell card radius mdl-color--madge mdl-shadow--4dp">
									...
									<div class="card__content card__padding">
									    ...
									    <div class="card__meta">
									        ...
									        <time class="mdl-button alignright"><?php _show_( $postsDetails['h_created'] ); ?></time>

									        <h2><a href="<?php _show_( hROOT.$postsDetails['h_link'] ); ?>"><?php _show_( $postsDetails['h_alias'] ); ?></a></h2>
									    </div>
									...
									<div class="mdl-card__menu">
										<h6><?php _show_( $postsDetails['h_alias'] ); ?></h6>
									</div>
								</div><?php
							} ?>
						</div>
					      ...
					      <div class="mmm-ribbon mdl-color--<?php if ( isset( $_SESSION['myCode'] ) ){ primaryColor(); } else { echo "madge"; } ?>" style="background: url( <?php _show_( $postsDetails['h_avatar']); ?> ); background-repeat:no-repeat; background-size: cover;">
					        ...
					        <div class="demo-container">
					          <div class="demo-content mdl-color--white content mdl-color-text--black mdl-grid">
					            <div class="mdl-cell mdl-cell--6-col mdl-color-text--grey-800 "><b><h3><?php _show_( $postsDetails['h_alias']); ?></h3></b></div>
				            <div class="mdl-cell mdl-cell--3-col mdl-color-text--grey-800 "><h6><b>Posted In: </b><?php _show_( $postsDetails['h_category']); ?></h6></div>
				            <div class="mdl-cell mdl-cell--3-col mdl-color-text--grey-800 "><h6><b>Tagged: </b><?php _show_( $postsDetails['h_tags']); ?></h6></div>
	...
	function home() {
		...
		if ( $getPosts -> num_rows > 0) { ?>
			<div class="mdl-grid">
				<div class="mdl-cell mdl-cell--12-col mdl-shadow--4dp mdl-grid mdl-color--madge"><?php 
					while ( $postsDetails = mysqli_fetch_assoc( $getPosts)){  ?>
