...
class _hActions {
	...
	**/
	...
	function frontlogo() {
		...
		echo '<br><a href="'.hROOT.'"><img src="'.hIMAGES.'logo-w.png" width="150px;"></a>';
	}
		...
		if ( isset( $_GET['register'] ) && $_GET['email'] !== "") {
			if ( _hActions::emailExists( $_GET['email'] ) ) {
				...
				<div style="padding-top:40px;" class="mdl-grid">
					...
					<div id="login_div" class="mdl-cell mdl-cell--8-col mdl-color--<?php if ( isset( $_SESSION['myCode'] ) ) { primaryColor(); } else { echo "madge"; } ?>">
						<center>
							<?php echo '<br><a href="'.hROOT.'"><img src="'.hIMAGES.'logo-w.png" width="150px;"></a>'; ?>
						</center>
						...
						<form enctype="multipart/form-data" name="registerUser" method="POST" action="" class="mdl-grid">
						  ...
						  <div class="input-field mdl-cell mdl-cell--6-col mdl-js-textfield getmdl-select getmdl-select__fix-height">
						    ...
						    <ul for="centers" class="mdl-menu mdl-menu--top-left mdl-js-menu mdl-color--<?php if ( isset( $_SESSION['myCode'] ) ) { primaryColor(); } else { echo "madge"; } ?>" style="max-height: 300px !important; overflow-y: auto;">
	      ...
	      include 'footer.php';
			...
			<div style="padding-top:40px;" class="mdl-grid">
				<div class="mdl-cell mdl-cell--2-col"></div>
				<div id="login_div" class="mdl-cell mdl-cell--8-col mdl-color--<?php if ( isset( $_SESSION['myCode'] ) ) { primaryColor(); } else { echo "madge"; } ?>">
				<center><br><?php echo '<a href="'.hROOT.'"><img src="'.hIMAGES.'logo-w.png" width="150px;"></a>'; 
				...
				<i class="mdl-icon-toggle__label material-icons">keyboard_arrow_down</i>
				   ...
				   <ul class="mdl-menu mdl-menu--bottom-left mdl-js-menu mdl-color--<?php if ( isset( $_SESSION['myCode'] ) ) { primaryColor(); } else { echo "madge"; } ?>" for="h_type" ><?php 
			...
			<div class="mdl-grid"><?php 
				while ( $postsDetails = mysqli_fetch_assoc( $getPosts)){  ?>
					<title><?php _show_( $postsDetails['h_alias']); ?> [ <?php showOption( 'name' ); ?> ]</title>
				      ...
				      <span><h6>Published by <b><a href="<?php _show_( hROOT.'users/'.$postsDetails['h_author']); ?>"><?php _show_( $postsDetails['h_by']); ?></a></b> on <b><?php $date = $postsDetails['h_created'];
