  ...
  function getChatCode($code) {
    ...
    <div class="mdl-grid" >
              <div class="mdl-cell mdl-cell--8-col-desktop mdl-cell--8-col-tablet mdl-cell--12-col-phone">
                    <div class="mdl-card mdl-shadow--2dp mdl-color--<?php primaryColor( $_SESSION['myCode']); ?>">
                    <div class="mdl-card__title">
                <h2 class="mdl-card__title-text"> Chat with <?php show( $messageDetails[0]['h_by'] ); ?></h2>
              </div>
              <title><?php show( $messageDetails[0]['h_by'] ); ?> [ JABALI Chats ]</title><?php
        foreach ($messageDetails as $message) { ?>
        <div class="mdl-card__supporting-text mdl-card--expand mdl-grid">
                <div class="mdl-cell mdl-cell--8-col-desktop mdl-cell--8-col-tablet mdl-cell--12-col-phone">
                  <div><?php show( $message['h_description'] ); ?>
                  <span class="alignright" >Sent: <?php show( $message['h_created'] ); ?></span></div>
                </div>
              </div><?php } ?>
              <div class="mdl-card__supporting-text mdl-card--expand">
                    <form enctype="multipart/form-data" name="messageForm" method="POST" action="">
                      <title>Create Message</title>
                        ...
                        <input type="hidden" name="h_for" value="<?php show( $_GET['code'] ); ?>">
