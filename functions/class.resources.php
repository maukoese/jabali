...
class _hResources {
  ...
  <i class="material-icons">edit</i></a>
      ...
      while ($resourcesDetails = mysqli_fetch_assoc($getResourcesBy)){
        ...
        <td class="mdl-data-table__cell--non-numeric">
        <a href="./resource?view=<?php show( $resourcesDetails['h_code'] ); ?>&key=<?php show( $resourcesDetails['h_alias'] ); ?>" ><i class="material-icons">open_in_new</i></a> 
        <a href="tel:<?php show( $resourcesDetails['h_phone'] ); ?>" ><i class="material-icons">phone</i></a> 
        <a href="?resource?message?create=message&code=<?php show( $_SESSION['myCode'] ); ?>" ><i class="material-icons">message</i></a>  
        <a href="./resource?edit=<?php show( $resourcesDetails['h_code'] ); ?>&key=<?php show( $resourcesDetails['h_alias'] ); ?>" ><i class="material-icons">edit</i></a> 
        <a href="./resource?delete=<?php show( $resourcesDetails['h_code'] ); ?>" ><i class="material-icons">delete</i></a>
              ...
              <div class="mdl-cell mdl-cell--8-col-desktop mdl-cell--8-col-tablet mdl-cell--12-col-phone">
                        ...
                        <div class="mdl-card__supporting-text mdl-card--expand mdl-grid">
                          <div class="mdl-cell mdl-cell--8-col-desktop mdl-cell--8-col-tablet mdl-cell--12-col-phone">
                            <h5>
                              <?php show ( $greettype ); ?>
                            <h5>
                            <h6><b>Admin Email:</b> <a href="mailto:<?php show( $resourceDetails['h_email'] ); ?>"><?php show( $resourceDetails['h_email'] ); ?></a><br><?php if ($resourceDetails['h_type'] !== "center") { ?>
                            <b>Center:</b> <a href="./resource?center=<?php show( $resourceDetails['h_center'] ); ?>"><?php show( $resourceDetails['h_center'] ); ?></a><br><?php } 
                            ?><b>Contact Phone:</b> <a href="tel:<?php show( $resourceDetails['h_phone'] ); ?>"><?php show( $resourceDetails['h_phone'] ); ?></a><br>
                            <b>Type: </b><?php show( $resourceDetails['h_type'] ); ?><br>
                            <b>County:</b> <a href="./resource?location=<?php show( $resourceDetails['h_location'] ); ?>"><?php show( ucwords($resourceDetails['h_location']) ); ?></a>
                            </h6>
                          ...
                          <div><h6><b>Added:</b> <?php show( $resourceDetails['h_created'] ); ?></h6></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mdl-cell mdl-cell--4-col-desktop mdl-cell--4-col-tablet mdl-cell--12-col-phone">
                    <div class="mdl-card mdl-shadow--2dp mdl-color--<?php primaryColor($_SESSION['myCode']); ?>">
                        ...
                        <li>
                          <div class="collapsible-header"><i class="material-icons">description</i>Posts from <?php show( ucfirst($name[0]) ); ?></div>
                          <div class="collapsible-body"><span>Lorem ipsum dolor sit amet.</span></div>
                        </li>
                      </ul>
                        </div>
