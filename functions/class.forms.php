      ...
      <div class="mdl-cell mdl-cell--8-col-desktop mdl-cell--8-col-tablet mdl-cell--12-col-phone mdl-card mdl-shadow--2dp mdl-card--expand mdl-color--<?php primaryColor( $_SESSION['myCode']); ?>">
        ...
        <i class="material-icons">mail</i>
          ...
          if (isset($_GET['code'])) {
            ...
            if (!empty($userDeet)) { 
              show( 'Message To '.$userDeet[0]["h_alias"] ); 
              } 
          } ?>
          </span>
          ...
          <div class="mdl-card__supporting-text mdl-card--expand">
              <form enctype="multipart/form-data" name="messageForm" method="POST" action="./message?create=message">
                <title>Compose <?php echo ucfirst($_GET['create']); ?> [ <?php getOption('name'); ?> ]</title>
                  ...
                  <?php if( $_GET['code']) { ?> <input type="hidden" name="h_for" value="<?php show( $_GET['code'] ); ?>"> <?php } else { ?>
                  ...
                  <div class="input-field">
                  <span class="mdl-button alignleft" type="file" name="attachment"><i class="material-icons">attach_file</i> Attach File</span>
            ...
            <div class="mdl-cell mdl-cell--8-col-desktop mdl-cell--8-col-tablet mdl-cell--12-col-phone mdl-card mdl-shadow--2dp mdl-card--expand mdl-color--<?php primaryColor($_SESSION['myCode']); ?>">
                <form enctype="multipart/form-data" name="postForm" method="POST" action="./post?edit=<?php show( $postDetails['h_code'] ); ?>" class="mdl-grid mdl-card__supporting-text mdl-card--expand">
                  <div class="mdl-cell mdl-cell--7-col-desktop mdl-cell--7-col-tablet mdl-cell--12-col-phone mdl-card mdl-shadow--2dp mdl-card--expand ">
                    <div class="mdl-cell mdl-cell--12-col">
                    <div class="input-field">
                    <input id="h_alias" type="text" name="h_alias" value="<?php show( $postDetails['h_alias'] ); ?>">
                    <label for="h_alias" data-error="wrong" data-success="right" class="center-align">Title</label>
                    </div>

                    <div class="input-field">
                    <input id="h_subtitle" type="text" name="h_subtitle" value="<?php show( $postDetails['h_subtitle'] ); ?>">
                    ...
                    <div class="input-field inline">
                    <i class="material-icons prefix">label</i>
                    <textarea id="h_tags" name="h_tags" class="materialize-textarea col s12"><?php show( $postDetails['h_tags'] ); ?></textarea>
                    <label for="h_tags" class="center-align">Tags</label>
                    </div>

                    <div class="input-field inline">
                    <i class="material-icons prefix">label_outline</i>
                    <textarea id="h_category" name="h_category" class="materialize-textarea col s12"><?php show( $postDetails['h_category'] ); ?></textarea>
                    <label for="h_category" class="center-align">Categories</label>
                    </div><?php
                    } 
  ...
  function userForm() { ?>
        ...
        <form enctype="multipart/form-data" name="registerUser" method="POST" action="<?php show ( hPORTAL.'user?create' ); ?>" class="mdl-cell mdl-cell--12-col-desktop mdl-cell--12-col-tablet mdl-cell--12-col-phone mdl-grid">
            <div class="mdl-cell mdl-cell--8-col-desktop mdl-cell--8-col-tablet mdl-cell--12-col-phone">
              ...
              <div class="input-field">
                <i class="material-icons prefix">description</i>
              <textarea  id="h_description" name="h_description" type="text" class="materialize-textarea" rows="5">Details about <?php show( $_GET['create']); ?>.</textarea>
            ...
            <div class="mdl-cell mdl-cell--4-col-desktop mdl-cell--4-col-tablet mdl-cell--12-col-phone">
              ...
              <img id="havatar" src="<?php show( hIMAGES.'avatar.svg' ); ?>" width="100%">
              ...
              <div class="mdl-card mdl-shadow--2dp mdl-color--<?php primaryColor($_SESSION['myCode']); ?>">
                  ...
                  <div class="mdl-card__supporting-text mdl-card--expand mdl-grid ">
                    <div class="mdl-cell mdl-cell--8-col-desktop mdl-cell--8-col-tablet mdl-cell--12-col-phone">
                      ...
                      <div class="input-field inline mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select">
                      <i class="mdi mdi-gender-transgender prefix"></i>
                       <input class="mdl-textfield__input" id="h_gender" name="h_gender" type="text" readonly tabIndex="-1" placeholder="<?php show( ucfirst($userDetails['h_gender']) ); ?>" value="<?php show( ucwords($userDetails['h_gender']) ); ?>">
                         <ul class="mdl-menu mdl-menu--bottom-left mdl-js-menu mdl-color--<?php primaryColor($_SESSION['myCode']); ?>" for="h_gender">
                           <li class="mdl-menu__item" data-val="male">Male</li>
                           <li class="mdl-menu__item" data-val="female">Female</li>
                           <li class="mdl-menu__item" data-val="other">Other</li>
                      ...
                      <div class="input-field mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height">
                        <i class="material-icons prefix">room</i>
                      <input class="mdl-textfield__input" type="text" id="counties" name="h_location" readonly tabIndex="-1" placeholder="<?php show( ucwords($userDetails['h_location']) ); ?>" value="<?php show( ucwords($userDetails['h_location']) ); ?>">
                      <ul for="counties" class="mdl-menu mdl-menu--bottom-left mdl-js-menu mdl-color--<?php primaryColor($_SESSION['myCode']); ?>" style="max-height: 300px !important; overflow-y: auto;">
                          <?php 
                          $county_list = "baringo, bomet, bungoma, busia, elgeyo-marakwet, embu, garissa, homa bay, isiolo, kakamega, kajiado, kapenguria, kericho, kiambu, kilifi, kirinyanga, kisii, kisumu, kitui, kwale, laikipia, lamu, machakos, makueni, mandera, marsabit, meru, migori, mombasa, muranga, nairobi, nakuru, nandi, narok, nyamira, nyandarua, nyeri, ol kalou, samburu, siaya, taita-taveta, tana river, tharaka-nithi, trans-nzoia, turkana, uasin-gishu, vihiga, wajir, west pokot";
                          $counties = explode(", ", $county_list);
                      ...
                      <div class="input-field <?php if( $userDetails['h_type'] !== "center") { ?>inline<? } ?>">
                      <i class="material-icons prefix">lock</i>
  ...
  function serviceForm() { ?>
        ...
        <form enctype="multipart/form-data" name="registerService" method="POST" action="<?php show ( hPORTAL.'service?create' ); ?>" class="mdl-cell mdl-cell--12-col-desktop mdl-cell--12-col-tablet mdl-cell--12-col-phone mdl-grid">
            <div class="mdl-cell mdl-cell--6-col-desktop mdl-cell--6-col-tablet mdl-cell--12-col-phone">
              ...
              <div class="input-field inline mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select">
                ...
                <div class="input-field inline mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select">
                  <i class="mdi mdi-adjust prefix"></i>
                   <input class="mdl-textfield__input" id="h_gender" name="h_gender" type="text" readonly tabIndex="-1" placeholder="<?php show( ucwords($_GET['create']) ); ?>" data-val="<?php show( $_GET['create'] ); ?>">
                     <ul class="mdl-menu mdl-menu--bottom-left mdl-js-menu mdl-color--<?php primaryColor($_SESSION['myCode']); ?>" for="h_gender">
              ...
              <div class="input-field mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height">
                <i class="material-icons prefix">room</i>
              <input class="mdl-textfield__input" type="text" id="counties" name="h_location" readonly tabIndex="-1" placeholder="<?php show( ucwords($_SESSION['myLocation']) ); ?>" data-val="<?php show( $_SESSION['myLocation'] ); ?>">
              <ul for="counties" class="mdl-menu mdl-menu--bottom-left mdl-js-menu mdl-color--<?php primaryColor($_SESSION['myCode']); ?>" style="max-height: 300px !important; overflow-y: auto;">
                  <?php 
                  $county_list = "baringo, bomet, bungoma, busia, elgeyo-marakwet, embu, garissa, homa bay, isiolo, kakamega, kajiado, kapenguria, kericho, kiambu, kilifi, kirinyanga, kisii, kisumu, kitui, kwale, laikipia, lamu, machakos, makueni, mandera, marsabit, meru, migori, mombasa, muranga, nairobi, nakuru, nandi, narok, nyamira, nyandarua, nyeri, ol kalou, samburu, siaya, taita-taveta, tana river, tharaka-nithi, trans-nzoia, turkana, uasin-gishu, vihiga, wajir, west pokot";
                  $counties = explode(", ", $county_list);
                  ...
                  <div class="mdl-card__supporting-text mdl-card--expand mdl-grid ">
                    ...
                    <script>
                     function chooseFile() {
                      ...
                      <img id="havatar" src="<?php show( $userDetails['h_avatar'] ); ?>" width="100%" onclick="chooseFile();">
                   ...
                   <script>
                    ...
                    function imageIsLoaded(e) {
                      ...
                      <input type="hidden" name="h_code" value="<?php show( $userDetails['h_code'] ); ?>" >
  ...
  function resourceForm() { ?>
        ...
        <form enctype="multipart/form-data" name="registerResource" method="POST" action="<?php show ( hPORTAL."resource?create=center" ); ?>" class="mdl-cell mdl-cell--12-col-desktop mdl-cell--12-col-tablet mdl-cell--12-col-phone mdl-grid">
            <div class="mdl-cell mdl-cell--8-col-desktop mdl-cell--8-col-tablet mdl-cell--12-col-phone">
              ...
              <div class="input-field mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height">
                <i class="material-icons prefix">room</i>
              <input class="mdl-textfield__input" type="text" id="counties" name="h_location" readonly tabIndex="-1" value="<?php show( ucwords( $_SESSION['myLocation'] ) ); ?>">
              <ul for="counties" class="mdl-menu mdl-menu--bottom-left mdl-js-menu mdl-color--<?php primaryColor($_SESSION['myCode']); ?>" style="max-height: 300px !important; overflow-y: auto;">
                  <?php 
                  $county_list = "baringo, bomet, bungoma, busia, elgeyo-marakwet, embu, garissa, homa bay, isiolo, kakamega, kajiado, kapenguria, kericho, kiambu, kilifi, kirinyanga, kisii, kisumu, kitui, kwale, laikipia, lamu, machakos, makueni, mandera, marsabit, meru, migori, mombasa, muranga, nairobi, nakuru, nandi, narok, nyamira, nyandarua, nyeri, ol kalou, samburu, siaya, taita-taveta, tana river, tharaka-nithi, trans-nzoia, turkana, uasin-gishu, vihiga, wajir, west pokot";
                  $counties = explode(", ", $county_list);
              ...
              <input class="mdl-textfield__input" type="text" id="doctors" name="h_author" readonly tabIndex="-1" placeholder="Doctor In Charge">
              ...
              <div class="mdl-card mdl-shadow--2dp mdl-color--<?php primaryColor($_SESSION['myCode']); ?>">
                  ...
                  <div class="mdl-card__supporting-text mdl-card--expand mdl-grid ">
                    <div class="mdl-cell mdl-cell--8-col-desktop mdl-cell--8-col-tablet mdl-cell--12-col-phone">
                      ...
                      <div class="input-field">
                      <i class="material-icons prefix">label</i>
                      <input id="h_alias" name="h_alias" type="text" value="<?php show( $resourceDetails['h_alias'] ); ?>">
                      <label for="h_alias">Resource Name</label>
                      </div>

                      <div class="input-field inline mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select">
                      <i class="material-icons prefix">business</i>
                       <input class="mdl-textfield__input" id="h_type" name="h_type" type="text" readonly tabIndex="-1" placeholder="<?php show( ucwords($resourceDetails['h_type']) ); ?>" value="<?php show( ucwords($resourceDetails['h_type']) ); ?>" >
                         <ul class="mdl-menu mdl-menu--bottom-left mdl-js-menu mdl-color--<?php primaryColor($_SESSION['myCode']); ?>" for="h_type">
                           <li class="mdl-menu__item" data-val="center">Center</li>
                      ...
                      <div class="input-field inline">
                      <i class="material-icons prefix">phone</i>
                      <input  id="h_phone" name="h_phone" type="text" value="<?php show( $resourceDetails['h_phone'] ); ?>">
                      <label for="h_phone" class="center-align">Contact Phone</label>
                      </div>

                      <div class="input-field mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height">
                        <i class="material-icons prefix">room</i>
                      <input class="mdl-textfield__input" type="text" id="counties" name="h_location" readonly tabIndex="-1" placeholder="<?php show( ucwords($resourceDetails['h_location']) ); ?>" value="<?php show( ucwords($resourceDetails['h_location']) ); ?>">
                      <ul for="counties" class="mdl-menu mdl-menu--bottom-left mdl-js-menu mdl-color--<?php primaryColor($_SESSION['myCode']); ?>" style="max-height: 300px !important; overflow-y: auto;">
                          <?php 
                          $county_list = "baringo, bomet, bungoma, busia, elgeyo-marakwet, embu, garissa, homa bay, isiolo, kakamega, kajiado, kapenguria, kericho, kiambu, kilifi, kirinyanga, kisii, kisumu, kitui, kwale, laikipia, lamu, machakos, makueni, mandera, marsabit, meru, migori, mombasa, muranga, nairobi, nakuru, nandi, narok, nyamira, nyandarua, nyeri, ol kalou, samburu, siaya, taita-taveta, tana river, tharaka-nithi, trans-nzoia, turkana, uasin-gishu, vihiga, wajir, west pokot";
                          $counties = explode(", ", $county_list);
                      ...
                      <div class="input-field">
                      <i class="material-icons prefix">local_hospital</i>
                      <input id="h_center" name="h_center" type="text" value="<?php show( $resourceDetails['h_center'] ); ?>">
                      <label for="h_center">Center</label>
                      </div>
                      <?php } ?>
                      ...
                      <div class="input-field">
                      <i class="material-icons prefix">mail</i>
                      <input class="validate" id="email" name="h_email" type="email" value="<?php show( $resourceDetails['h_email'] ); ?>">
                      ...
                      <i class="mdi mdi-bio prefix"></i>
                      <textarea class="materialize-textarea col s12" rows="5" id="h_description" name="h_description" >
                      <?php show( $resourceDetails['h_description'] ); ?>
                      </textarea>
                      <script>CKEDITOR.replace( 'h_description' );</script>
                    ...
                    <script>
                     function chooseFile() {
                      ...
                      <img id="havatar" src="<?php show( $resourceDetails['h_avatar'] ); ?>" width="100%" onclick="chooseFile();">
