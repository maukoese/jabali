...
class _hForms {
  ...
  function articleForm() {  
    ?><div class="mdl-grid">
            ...
            <div class="mdl-cell mdl-cell--4-col-desktop mdl-cell--4-col-tablet mdl-cell--12-col-phone mdl-color--<?php primaryColor($_SESSION['myCode']); ?>">
            <?php
...
function notificationForm() {
  ...
  function userForm() {
        ...
        ?><title><?php show( $userDetails['h_alias'] ); ?> Create <?php show( ucfirst($_GET['create']) ); ?> [ <?php getOption('name'); ?> ]</title>
                    ...
                    <div class="mdl-card mdl-shadow--2dp mdl-color--<?php primaryColor($_SESSION['myCode']); ?>">
                        <div class="mdl-card__supporting-text mdl-card--expand mdl-grid">
                          <div class="mdl-cell mdl-cell--8-col-desktop mdl-cell--8-col-tablet mdl-cell--12-col-phone">
                            ...
                            <div class="input-field inline">
                            <i class="mdi-action-lock-outline prefix"></i>
                            <input class="mdl-textfield__input mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select" type="text" name="h_type" id="h_type" value="" list="post_types" value="<?php show( $_GET['create'] ); ?>">
                            <div class="mdl-card">
                    ...
                    <div class="mdl-card mdl-shadow--2dp mdl-color--<?php primaryColor($_SESSION['myCode']); ?>">
                        ...
                        <div class="mdl-card__supporting-text mdl-card--expand mdl-grid ">
                          <div class="mdl-cell mdl-cell--8-col-desktop mdl-cell--8-col-tablet mdl-cell--12-col-phone">
                            ...
                            <div class="input-field inline">
                            <i class="mdi-action-lock-outline prefix"></i>
                            <input id="h_location" name="h_location" type="text" value="<?php show( ucwords($userDetails['h_location']) ); ?>">
