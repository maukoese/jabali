...
if (isset($_POST['create'])) {
    ...
    VALUES ('".$h_alias."', '".$h_author."', '".$h_avatar."', '".$h_center."', '".$h_code."', '".$h_created."', '".$h_email."', '".$h_key."', '".$h_level."', '".$h_link."', '".$h_location."', '".$h_notes."', '".$h_password."', '".$h_phone."', '".$h_status."', '".$h_style."', '".$h_type."', '".$h_username."')";
      ...
      if (mysqli_query($conn, $sql)) {
        ?>
        <div id="success" class="modal mdl-color--green">
        ...
        ?>
        <div id="fail" class="modal mdl-color--red">
            <div class="uk-modal-dialog">
                <a class="uk-modal-close uk-close"></a>
              <h2>Oops!</h2>
...
<center><?php frontlogo(); ?></center>
    ...
    <div id="test-swipe-1" class="col s12">
        ...
        <input class="mdl-textfield__input" type="text" id="counties" name="h_location" placeholder="Location" readonly tabIndex="-1">
